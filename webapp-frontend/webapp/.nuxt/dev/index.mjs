...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///usr/src/app/node_modules/ufo/dist/index.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/png","href":"/favicon.ico"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css?family=Roboto:300,400,500,700,900&display=swap"}],"style":[],"script":[],"noscript":[],"title":"Medical Image Processing"};
